...
def extrair_dados():
    ...
    ordem_analitos = [
        ...
        ["Naftaleno", "Acenaftileno", "Acenafteno", "Fluoreno", "Fenantreno", "Antraceno", "Fluoranteno", "Pireno", 
         "Benzo(a)antraceno", "Criseno", "Benzo(b)fluoranteno", "Benzo(k)fluoranteno", "Benzo(a)pireno", 
         "Indeno(1,2,3-cd)pireno", "Dibenzo(a,h)antraceno", "Benzo(g,h,i)perileno", "Estireno", "Etanol"]        
    ]
    # Criar uma lista com a ordem desejada de todas as análises
    ...
    for filename in os.listdir(diretorio_entrada):
        if filename.endswith('.xlsx'):
            ...
            data_coleta = df.iloc[7, 0]  
            datas_coleta.append(data_coleta)

            coluna_A = df.iloc[19:41, 0] 
            coluna_C = df.iloc[19:41, 2]  
            coluna_E = df.iloc[19:41, 4]  
            coluna_J = df.iloc[19:41, 9] 
    ...
    # Reindexar o DataFrame usando a ordem desejada
